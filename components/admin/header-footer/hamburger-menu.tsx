...
const HamburgerMenuAdmin = () => {
  ...
  return (
    <div className="contents sm:flex w-full relative md:hidden justify-between my-5 md:pt-5 items-center mx-5">
      ...
      <ul
        className={`${
          isOpen ? "flex" : "hidden"
        } flex-col gap-8 justify-center z-50 bg-slate-200 absolute top-16 left-0 rounded text-gray-800 w-full p-5`}
      >
        ...
        <li className="hover:text-orange flex gap-2 items-center">
          <GrArticle className="w-6 h-6 cursor-pointer" />
