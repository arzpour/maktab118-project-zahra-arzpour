...
const PurchaseStatusPage = () => {
  ...
  const editProductsHandler = async () => {
    ...
    //     console.log(productItem?.selectedQuantity, "productItem?.quantity");

    //     console.log((el.quantity! -= productItem?.selectedQuantity!), "kaamm");

    //     if (productItem && el.quantity) {
    //       const newQuantity = (el.quantity -= productItem.selectedQuantity);
    //       return newQuantity >= 0;
    //     }
    //     return false;
    //   }) || [];
